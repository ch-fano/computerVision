...
class RecognitionPipeline:
    ...
    def get_imgtype_max_value(self, dtype):
        """
    ...
    def get_brightness(self, img_path):
        ...
        max_val = self.get_imgtype_max_value(image.dtype)
    ...
    def is_illumination(self, img_path, threshold):
        """
        ...
        brightness = self.get_brightness(img_path)
